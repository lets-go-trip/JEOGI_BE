...
public class ParkingLotReservationController {
    ...
    public int getAvailableParkingSpaces(
            @PathVariable(name = "parkingLotId") int parkingLotId,
            @ParameterObject @ModelAttribute ParkingReservationRequest request) {
    ...
    public ResponseEntity<ParkingReservationResponse> createParkingReservation(
            ...
            @PathVariable(name = "parkingLotId") Integer parkingLotId,
